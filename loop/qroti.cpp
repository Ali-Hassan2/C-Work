...
void channy()
					...
					case 3:
						{
							cout<<"How many plates do you want : "<<endl;
							cin>>choice;
							total3 = choice * sadidaal;
							cout<<"The total price is = "<<total3<<endl;
							break;
						}
						case 4:
							{
								...
								cin>>choice;
								total4=choice*mashdaal;
								cout<<"The total price is = "<<total4<<endl;
								break;
							}
	...
	void roti()
	{
		...
		int option;
		int choice;
		cout<<"1.For the Roti..."<<endl;
		cout<<"2.For the Naan..."<<endl;
		cout<<"Enter the choice : "<<endl;
		cin>>option;
		switch(option)
		{
	...
	void coldrink()
	{
		...
		int choice;
		int option;
		cout<<"%%%%%%%%%%%*****AS WE ARE OFFERING ONLY REGULAR DRINKS*****%%%%%%%%%%%%\n"<<endl;
		cout<<"1.For the Pepsi..."<<endl;
		cout<<"2.For the Sting...."<<endl;
		cout<<"3.For the Dew...."<<endl;
		cout<<"Enter the choice : "<<endl;
		cin>>choice;
		...
		switch(choice)
		{
			case 1:
				{
					cout<<"Enter the number of the cold drinks : "<<endl;
					cin>>option;
					
					total1 = option * pepsi;
					cout<<"The total price = "<<total1<<endl;
					break;
				}
				case 2:
					{
					...
					total3 = option * dew;
					cout<<"The total price = "<<total3<<endl;
					break;
						}
		}
	}
