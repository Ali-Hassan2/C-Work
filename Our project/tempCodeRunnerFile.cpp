...
cout<<"\t\t\t | ____________________________________________________________________ |"<<endl;
cout<<"\t\t\t | Sr.  |     Name      |  Serial No. |    Quantity    |   Prics (WS)   |"<<endl;
cout<<"\t\t\t | ____________________________________________________________________ |"<<endl;
cout<<"\t\t\t |  1   |    Panadol    |    0001     |      100pkg    |    1500 PKR    |"<<endl;
cout<<"\t\t\t |  2   |    Benzoic    |    0002     |      100pkg    |    1700 PKR    |"<<endl;
cout<<"\t\t\t |  3   |     Flygl     |    0003     |      100pkg    |    1200 PKR    |"<<endl;
cout<<"\t\t\t |  4   |    Vitamin    |    0004     |      100pkg    |    1800 PKR    |"<<endl;
cout<<"\t\t\t |  5   |     Fibre     |    0005     |      100pkg    |    1900 PKR    |"<<endl;
cout<<"\t\t\t |  6   |    Surbex     |    0006     |      100pkg    |    2200 PKR    |"<<endl;
cout<<"\t\t\t |                                                                      |"<<endl;
cout<<"\t\t\t  =====================================================================  "<<endl;  
