...
void Ticket::updateTicket()
{
    ...
    cin >> uid;
    fstream file;
    file.open("E:\\ticket.txt", ios::in | ios::out); // Open for both reading and writing
    ...
    if (file.is_open()) {
        ...
        while (getline(file, line)) {
            ...
            if (pos != string::npos) {
                ...
                // Update the event details in the file
                file.seekp(pos); // Move to the position of the found line
                file << "ID: " << updatetic.tid << "  Type: " << updatetic.type << "  Price: " << updatetic.price << "  Expiry Date: " << updatetic.d.dd << "/" << updatetic.d.mm << "/" << updatetic.d.yyyy << endl;
                break;
            }
        }
        ...
        if (ticketFound) {
            ...
            cout << "Ticket with ID " << uid << " not found. No changes were made." << endl;
        }
    }
    else {
        cout << "Error in opening the file." << endl;
...
void Ticket::cancelTicket()
{
    ...
    if (inputfile.is_open())
    {
        ...
        if (outputfile.is_open())
        {
            ...
            {
                remove("E:\\ticket.txt");
                rename("E:\\temp_ticket.txt", "E:\\ticket.txt");
                cout << "Ticket with ID " << rid << " removed successfully..!!" << endl;
            }
            else
            {
                remove("E:\\temp_ticket.txt");
